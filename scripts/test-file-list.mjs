export const testFiles = [
  ...
  'src/app/appProjectNewCommand.test.ts',
  'src/app/appProjectReplacementGuard.test.ts',
  'src/app/appWorkspaceNavigationCommand.test.ts',
  'src/app/appWorkspaceNavigationApply.test.ts',
  'src/app/appApplicationCommandFeedback.test.ts',
  'src/app/appHomeResume.test.ts',
  'src/app/applicationLifecycleRuntime.test.ts',
  'src/app/applicationDocumentSelectionOwnership.test.ts',
  'src/app/useApplicationMenuLifecycleIngress.test.ts',
  'src/app/applicationLifecycleSynchronization.test.ts',
  'src/components/project/ProjectReplacementDialog.test.ts',
  ...
  'src/app/appPngExportCommand.test.ts',
  ...
  'src/app/jewelCaseEssentialsCasePreset.integration.test.ts',
  ...
  'src/applicationMenu/applicationMenuLifecycleRouting.test.ts',
  'src/applicationMenu/applicationMenuWorkflowRouting.test.ts',
  'src/applicationMenu/inMemoryApplicationMenuPort.test.ts',
  'src/applicationMenu/nativeApplicationMenuTransport.test.ts',
  'src/applicationMenu/nativeApplicationMenuPort.test.ts',
  'src/applicationMenu/applicationMenuRuntime.test.ts',
  'src/applicationMenu/windowsWebviewApplicationMenuAccelerators.test.ts',
  'src/editor/editorNavigationRouter.test.ts',
  'src/editor/applicationWorkflowNavigationStore.test.ts',
  ...
  'src/components/sidebar/ImageCandidatePicker.test.ts',
  'src/components/sidebar/imageCandidatePickerFocus.test.ts',
  'src/components/testing/keyboardModalIntegration.test.mjs',
  ...
  'src/components/editor/ApplicationWorkflowHost.test.ts',
  ...
  'src/components/preview/previewViewportInteractionOwnership.test.ts',
  ...
  'src/caseInsert/artworkViewportAdoption.test.ts',
  'src/caseInsert/presetArtworkSlotProvisioning.test.ts',
  ...
  'src/project/projectCaseInsertArtworkViewportPersistence.test.ts',
  ...
  'src/presets/caseInsertPresetDefinition.test.ts',
  'src/presets/caseInsertPresetCatalog.test.ts',
  ...
  'src/presets/caseInsertPresetApplyArtworkActions.test.ts',
  ...
  'src/presets/caseInsertPresetTypedReapply.test.ts',
  'src/presets/caseInsertPresetDetachPlanning.test.ts',
  'src/presets/caseInsertPresetDetachTransition.test.ts',
  'src/presets/caseInsertPresetConfigurationAdoptionModel.test.ts',
  'src/presets/caseInsertPresetApplicationAdoption.testFixture.test.ts',
  'src/presets/caseInsertPresetApplicationAdoptionTransition.test.ts',
  ...
  'src/render/caseInsertArtworkViewportRenderArtifact.test.ts',
