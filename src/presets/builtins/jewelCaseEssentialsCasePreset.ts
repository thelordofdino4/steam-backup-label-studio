...
export const JEWEL_CASE_ESSENTIALS_CASE_PRESET_ID =
  'builtin:case-preset:jewel-case-essentials' as const

export const JEWEL_CASE_ESSENTIALS_CASE_PRESET_REVISION = 1 as const

const JEWEL_CASE_ESSENTIALS_CASE_PRESET_SOURCE = {
...
const parsedJewelCaseEssentials = parseCaseInsertPresetDefinition(
  JEWEL_CASE_ESSENTIALS_CASE_PRESET_SOURCE,
)

if (!parsedJewelCaseEssentials.ok) {
  throw new Error(
    `Invalid built-in Jewel Case Essentials preset at ${parsedJewelCaseEssentials.error.path}.`,
  )
}

export const JEWEL_CASE_ESSENTIALS_CASE_PRESET:
  CaseInsertPresetDefinitionV1 = parsedJewelCaseEssentials.value
