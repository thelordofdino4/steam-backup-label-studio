...
- Curved disc text remains SVG/textPath unless a future ADR changes it.
...
- Current shell adoption covers Steam banner controls, media marks, case insert game-logo/title artwork, disc game title/logo artwork, disc primary developer/publisher logos, case insert primary developer/publisher logo slots, additional-artwork global gates, and additional-artwork frame gates. More complex optional visuals such as background artwork, rating badge, platform marks, technical marks, repeated visual element cards, and text sections retain their existing shells unless separately migrated with their feature-owned semantics preserved.
...
- Shared text infrastructure may support straight text, but curved text keeps a disc-specific renderer.
