...
`docs/archive/EDITOR_UNIFICATION_FINAL_AUDIT.md`. Use that audit to preserve shared
...
- Jewel case editor alpha definition (#126), mirrored in `docs/archive/JEWEL_CASE_EDITOR_ISSUE_DRAFT.md`.
